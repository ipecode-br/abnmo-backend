...
export const surveySchema = baseEntitySchema.extend({
  ...
  signatureDocumentId: z.string().max(64).nullable(),
  // About
  ...
  diagnosingDoctorName: z.string().min(1).nullable(),
  diagnosisHospitalName: z.string().min(1).nullable(),
  diagnosisHospitalCep: cepSchema.nullable(),
  diagnosisHospitalState: z.enum(BRAZIL_STATES).nullable(),
  diagnosisHospitalCity: z.string().min(1).nullable(),
  diagnosisHospitalStreet: z.string().min(1).nullable(),
  diagnosisDate: dateSchema,
  diagnosisDocument: z.string().min(1).nullable(),
  currentNeurologist: z.string().min(1).nullable(),
  currentTreatmentHospital: z.string().min(1).nullable(),
  ...
  otherFollowUpProfessionals: z.array(z.string().min(1)).default([]),
  followUpHow: z.enum(FOLLOW_UP_HOW),
  hasHealthInsurance: z.boolean(),
  nmoMedications: z.array(z.string().min(1)).default([]),
  crisesAfterMedication: z.number().min(0).nullable(),
  legalActionForMedication: z.enum(LEGAL_ACTIONS),
  generalMedications: z.array(z.string().min(1)).default([]),
  ...
  otherSequelae: z.string().min(1).max(300).nullable(),
  ...
  otherDiseaseDescription: z.string().min(1).max(200).nullable(),
  // Daily life
